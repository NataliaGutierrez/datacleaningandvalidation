...
Inicialment, seleccionem totes les variables per la nostra anàlisis de dades. No obstant, pot ser que en alguna fase de l'anàlisi es descarti alguna d'elles per no ser significativa per al model de predicció final.
...
Obtenim que només 4 variables presenten homogeneïtat de variància respecte *quality*.

## Correlació entre variables

Ja que les variables no presenten normalitat, fem servir el mètode no paramètric de Spearman [@Dalgaard].
